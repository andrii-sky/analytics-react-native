...
import type { Context, DeepPartial, IntegrationSettings, SegmentAPIIntegrations, UserInfoState } from '../types';
/**
...
export interface Storage {
    ...
    readonly settings: Watchable<SegmentAPIIntegrations | undefined> & Settable<SegmentAPIIntegrations> & Dictionary<string, IntegrationSettings>;
    readonly events: Watchable<SegmentEvent[]> & Queue<SegmentEvent | SegmentEvent[]>;
